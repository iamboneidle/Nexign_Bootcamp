package hrs.hrs_service.Configs;
...
public class RedisConfig {
     ...
     */
    @Bean
    public RedisTemplate<String, Rates> redisCacheTemplate(LettuceConnectionFactory redisConnectionFactory) {
        RedisTemplate<String, Rates> template = new RedisTemplate<>();
     ...
     */
    @Bean
    public SetOperations<String, Rates> setOperations(RedisTemplate<String, Rates> redisTemplate) {
